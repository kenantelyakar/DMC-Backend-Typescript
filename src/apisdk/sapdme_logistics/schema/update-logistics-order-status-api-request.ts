...
/**
 * Representation of the 'UpdateLogisticsOrderStatusApiRequest' schema.
 */
export type UpdateLogisticsOrderStatusApiRequest =
  | {
      /**
       * The ID is used for updating logistics order. There are 3 possible types of ID: CARRIER_ID, ORDER_NUMBER and REFERENCE_NUMBER
       */
      id: string;
      /**
