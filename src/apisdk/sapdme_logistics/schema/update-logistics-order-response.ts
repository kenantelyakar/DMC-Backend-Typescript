 ...
 */
export type UpdateLogisticsOrderResponse =
  | {
      /**
      ...
      /**
       * The source type of the shop floor control (SFC), packing unit or carrier. There are 3 possible source types: RESOURCE, WORK_CENTER or STORAGE_LOCATION.
       */
      ...
      /**
       * The ID of the operator who processes the logistics order. This ID is configured when the user was created. It could be email address or any name that uniquely identifies the operator.
       */
