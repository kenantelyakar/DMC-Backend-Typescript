...
exports.BatchApi = {
     ...
     */
    createBatchByMaterialUsingPost1: (body) => new openapi_1.OpenApiRequestBuilder('post', '/batch', {
        body
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getBatchesUsingGet2: (queryParameters) => new openapi_1.OpenApiRequestBuilder('get', '/batches', {
        queryParameters
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    syncBatchUsingPost: (batchNumber, queryParameters) => new openapi_1.OpenApiRequestBuilder('post', '/batches/{batchNumber}/synchronization', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    patchBatchesUsingPatch: (batchNumber, body, queryParameters) => new openapi_1.OpenApiRequestBuilder('patch', '/batches/{batchNumber}', {
        pathParameters: { batchNumber },
        body,
        queryParameters
    })
