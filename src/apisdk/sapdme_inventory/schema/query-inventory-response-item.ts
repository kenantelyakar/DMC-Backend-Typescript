 ...
 */
import type { QueryInventoryAssemblyData } from './query-inventory-assembly-data';
import type { GetInventoryResponseItemQuantity } from './get-inventory-response-item-quantity';
/**
 * Representation of the 'QueryInventoryResponseItem' schema.
 */
export type QueryInventoryResponseItem =
  | {
      assemblyData?: QueryInventoryAssemblyData[];
      /**
